...
//   searchQuery: string;
//   setSearchQuery: React.Dispatch<React.SetStateAction<string>>; // Ensure the type matches
// }
...
//         Explore limitless stories, learn with every page <span className="hidden sm:flex"> - your online library awaits!</span>
//       </div>
//       <div className="flex flex-col md:flex-row justify-between p-3 px-5 lg:p-4 lg:px-10 xl:px-20">
//         <div className="flex items-center text-black">
//           <span className="lg:text-5xl text-3xl mr-2 text-red-600">
//             <FaBook />
//           </span>
//           <h1 className="text-2xl sm:text-3xl lg:text-4xl">Readify</h1>
//         </div>
//         <div className="flex items-center w-full md:w-[70%] xl:w-[50%] my-4 text-2xl h-10">
//           <Input
//             className="h-full rounded-sm border py-2 px-3 rounded-tr-none rounded-br-none border-gray-400 placeholder-gray-100 bg-white text-sm md:text-md lg:text-lg"
//             type="text"
//             placeholder="Search by title or author"
//             value={searchQuery} // Controlled input
//             onChange={(e) => setSearchQuery(e.target.value)} // Update state
//           />
//           <Button className="bg-red-600 text-[20px] h-full w-10 lg:w-14 text-white rounded-sm rounded-tl-none rounded-bl-none">
//             <Link href={"/components/booklist"}><IoMdSearch size={20} /></Link> 
//           </Button>
//         </div>
//       </div>
//     </header>
