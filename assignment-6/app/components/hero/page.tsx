...
const Hero = () => {
  return (
    <main className="flex flex-col md:flex-row items-center justify-evenly md:justify-between bg-[linear-gradient(-135deg,_#1A1A1A,_#0DCAF0)] h-[650px] px-4 md:px-10 lg:px-20">
