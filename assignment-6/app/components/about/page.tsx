...
const About = () => {
  return (
    <main id='aboutSection' className='bg-aboutColor py-14 md:py-10 xl:py-16 xl:px-10'>
    <div className='h-fit md:h-[600px] xl:h-[620px] flex flex-col md:flex-row w-[95%] lg:w-[90%] justify-between items-center text-gray-100 mx-auto'>
